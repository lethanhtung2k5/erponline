  ...
  <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
    <div class="user-info-wrapper sm">
      <div class="profile-wrapper sm">
        <img src="{{ asset('admin/assets/img/profiles/avatar.jpg') }}" alt="" data-src="{{ asset('admin/assets/img/profiles/avatar.jpg') }}" data-src-retina="{{ asset('admin/assets/img/profiles/avatar2x.jpg') }}" width="69" height="69" />
    ...
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li> <a href="/admincp/department">Phòng ban</a> </li>
          <li> <a href="/admincp/regency">Chức vụ</a> </li>
          <li> <a href="/admincp/typeEmployee">Loại nhân viên</a> </li>
          <li> <a href="/admincp/typeCustomer">Loại khách hàng</a> </li>
        </ul>
      </li>
